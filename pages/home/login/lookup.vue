<template>
	<view class="ex-body">
		...
		<view class="marginTop186 "><image src="../../../static/image/login/lookup.png" mode="widthFix" style="width:252upx;height:55upx;"></image></view>
		<view class="ex-tab marginTop128">
			<form @submit="updatePwd" class="ex-form">
...
export default {
	...
	methods: {
		...
		getVCode: function() {
			...
			this.$http
				.post('VerificationCodeCreate', { user_name: this.phoneno, type: 3,area_code:this.pnpre })
				.then(res => {
					if (res.data.code == 0) {
						uni.showToast({
							title: '发送成功',
