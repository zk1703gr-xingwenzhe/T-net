<template>
	<view class="Alipay">
		<navbar :isshowa="true">{{lang.memberWeChat}}</navbar>
		<view class="Alipay_box">
			...
			<view class="Ali_name">
				...
				<input class="Ali_name2" type="text" disabled="disabled" v-model="Ali_name2"/>
			</view>
			<!-- 账号 -->
			<view class="AccountNumber">
				...
				<input class="AccountNumber2" type="text" :placeholder="lang.memberPwaccount"  v-model="AccountNumber2"/>
			</view>
	...
	export default {
		...
		methods: {
			...
			add:function(){//添加
				...
				uni.uploadFile({
					url: 'https://api.sstex.co/api/addUserPayment',
