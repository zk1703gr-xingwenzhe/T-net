<template>
	<scroll-view 
	:class="['ex-nav-bar', isCenter ? 'ex-nav-center' : '']" :scroll-x="true" 
...
export default {
	props:{
		...
		activeLineBg : {
			type : String,
			default : "linear-gradient(to right, #D7C295,#C69960)"
		},
		activeColor:{
			type : String,
			default : "#333333"
...
<style>
.ex-nav-bar{width:100%; display:flex; white-space:nowrap; padding-bottom:10rpx;}
...
.ex-nav-center{justify-content:center; text-align:center;}
</style>